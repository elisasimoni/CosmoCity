...
public class CreateColonyPage extends ViewImpl implements CreateColonyPageView {
    ...
    private final SimulationController simulatorController;
    private final Map<String, Integer> selectedSettlers = new HashMap<>();
    private Text colonyNameText;
    private ComboBox<String> difficultyComboBox;
    private Text warningText;

    public CreateColonyPage(final Stage stage, final double width, final double height,
            final SimulationController simulatorController) {
        super(stage, width, height);
        this.simulatorController = simulatorController;
        this.createColonyController = new CreateColonyController(this.simulatorController);
    }
    ...
    private VBox createImageControl(String imageURL, String nameSettler) {
        ...
        plusButton.setOnAction(event -> {
            final int count = Integer.parseInt(counterLabel.getText());
        ...
        final HBox controls = new HBox(minusButton, counterLabel, plusButton);
    ...
    private ComboBox<String> difficultyChooser() {
        final ObservableList<String> difficultyOptions = FXCollections.observableArrayList(
                "EASY",
                "MEDIUM",
                "HARD");

        final ComboBox<String> comboBox = new ComboBox<>(difficultyOptions);
